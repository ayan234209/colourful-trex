...
function preload(){
  trex_running = loadAnimation("trex2.png");
 ...
 cloudImage = loadImage("cloud.png");
  ...
  obstacle1 = loadImage("ob2.png");
  obstacle2 = loadImage("ob2.png");
  obstacle3 = loadImage("ob2.png");
  obstacle4 = loadImage("ob2.png");
  obstacle5 = loadImage("ob2.png");
  obstacle6 = loadImage("ob2.png");
...
function setup() {
 ...
 console.log(message)
  ...
  trex = createSprite(200,20,20,50);
 ...
 ground.addImage("ground",groundImage);
  ...
  invisibleGround = createSprite(window.width,window.height,400,10);
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(window.width-20,window.height-60,10,40);
